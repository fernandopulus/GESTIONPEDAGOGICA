// Script de prueba para invocar generarPruebaConGemini localmente
...
async function runTest() {
  ...
  // Construir request simulado. Algunas funciones verifican request.app para App Check.
  const fakeRequest = {
    data: {
    ...
    // Simular app para pasar la verificación si la función la exige
    app: { checkToken: 'fake' },
    auth: { uid: 'test-user' }
  };
