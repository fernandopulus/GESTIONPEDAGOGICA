...
import {
  ...
  createCicloOPR,
  updateCicloOPR,
  uploadFileImproved as uploadFile, // 👈 importante
    ...
    <div>
      ...
      <div className="mb-8">
        <h3 className="flex items-center gap-2 text-xl font-semibold text-slate-700 dark:text-slate-300 mb-4">
          <BarChart3 className="w-6 h-6 text-amber-500" /> Acompañamientos Registrados
        </h3>
          ...
          <CicloOPRForm
            ...
            onSave={async (data) => {
              try {
                const dataToSave = {
                  ...data,
                  acompanamientoId: currentAcompanamiento?.id || null,
                };
